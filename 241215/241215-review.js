...
// literal
// string, num, boolean, undefined, null, symbol, array
...
console.log(obj3.a);
console.log(obj3.f.a);
console.log(obj3["b"]);

const obj3I = "i";

console.log(obj3[obj3I]["a"]);
...
console.log(arr2[0]);
console.log(arr2[5]);
console.log(arr2[5].a);
console.log(arr2[5].b[0]);

console.log(arr2[5].c.a[2]);
...
// 선언식 함수
// function이라는 예약얼르 사용해서 함수를 선언하는 방식
...
function run() {
  ...
  // return이 없으면 암묵적으로 반드시 undefined을 return한다
